...
<head>
  ...
  <script src="{{ asset('/') }}backend/https://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
  <![endif]-->
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="{{ asset('/') }}backend/#" class="sidebar-toggle" data-toggle="push-menu" role="button">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="{{ asset('/') }}backend/#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="{{ asset('/') }}backend/#">View all</a></li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>{{ Auth::user()->name }}</p>
          <a href="{{ asset('/') }}backend/#"><i class="fa fa-circle text-success"></i> Online</a>
        </div>
      </div>
      <!-- search form -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('add-menu-index') }}"><i class="fa fa-circle-o"></i> Add Menu</a></li>
...
@yield('body-content')
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="#">Admin Template</a>.</strong> All rights
    reserved.
  </footer>
